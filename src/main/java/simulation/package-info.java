/**
 * ce package contient le coeur de la simulation, c'est a dire 
 * les classes indispensables pour toute simulation, peu importe 
 * le theme.
 * 
 * Ce package contient le sous package generation pour chaque generation 
 * d'invidus.
 * 
